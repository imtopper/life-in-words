<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Poetry_Site1.Home" %>
...
<html>
	<head runat="server">
		...
		<!-- Font awesome C<a href="Home.aspx">Home.aspx</a>SS -->
		...
		<div class="wrapper">
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">Publish <span class="caret"></span></a>
			...
			<div class="main-content bottom-0">
				<div class="container">
					...
					<div class="banner pad">
						<!-- heading -->
						<h2><br><span>Life In Words</span></h2>
						<!-- paragraph -->
						<b><p>"World best online poetry publisher"</p></b>
					</div>
				</div>
			...
			<footer>
				<div class="container">
					...
					<p class="copy-right">Copyright &copy; 2021 <a href="#">Life In Words</a> | Designed By : <a href="http://www.indioweb.in/portfolio">Suniti</a>, All rights reserved. </p>
				</div>
			</footer>
		</div>		
